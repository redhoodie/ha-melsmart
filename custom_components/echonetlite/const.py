...
ENL_OP_CODES = {
    ...
    0x01: {  # Air Conditioner-related Device
        ...
        0x33: {  # Ventilation fan (Lossnay / ERV)
            0xA0: {
                CONF_ICON: "mdi:fan",
            },
            0xBF: {
        ...
        0x34: {  # Air conditioner ventilation fan (Lossnay / ERV)
            0xA0: {
                CONF_ICON: "mdi:fan",
            },
            0xB0: {
            ...
            0xBE: {
                CONF_NAME: "Outdoor air temperature",
                CONF_TYPE: SensorDeviceClass.TEMPERATURE,
                CONF_STATE_CLASS: SensorStateClass.MEASUREMENT,
            },
            0xBF: {
            ...
            0xC0: {
                CONF_TYPE: SensorDeviceClass.CO2,
                CONF_STATE_CLASS: SensorStateClass.MEASUREMENT,
            },
            0xC1: {
            ...
            0xD0: {
                CONF_NAME: "Return air temperature",
                CONF_TYPE: SensorDeviceClass.TEMPERATURE,
                CONF_STATE_CLASS: SensorStateClass.MEASUREMENT,
            },
            0xD2: {
                CONF_NAME: "Supply air temperature",
                CONF_TYPE: SensorDeviceClass.TEMPERATURE,
                CONF_STATE_CLASS: SensorStateClass.MEASUREMENT,
            },
            0xD4: {
                CONF_NAME: "Exhaust air temperature",
                CONF_TYPE: SensorDeviceClass.TEMPERATURE,
                CONF_STATE_CLASS: SensorStateClass.MEASUREMENT,
            },
            0xE0: {
                CONF_NAME: "Heat exchanger",
...
NON_SETUP_SINGLE_ENTITY = {
    0x01: {
        ...
        # Ventilation fan / Lossnay — fan entity owns power and airflow
        0x33: {ENL_STATUS, ENL_FANSPEED},
        0x34: {ENL_STATUS, ENL_FANSPEED},
    },
    0x02: {
